...
It also normalizes curated argument aliases (e.g. ``query`` -> ``text``) before
...
from mavedb_link.mcp.arg_help import (
...
from mavedb_link.mcp.envelope import build_arg_error_envelope
